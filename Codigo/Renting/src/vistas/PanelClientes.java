...
public class PanelClientes extends JPanel implements InterfazCliente.Vista {
	...
	private void nuevoCliente() {
		DialogoFormularioClientes dialogoClientes = new DialogoFormularioClientes(PanelClientes.this);
	...
	public void editarCliente(int filaSeleccionada) {
		ModeloTablaClientes modeloTabla = (ModeloTablaClientes) tableReservas.getModel();
		Cliente clienteAEditar = modeloTabla.getListaCliente().get(filaSeleccionada);
		DialogoFormularioCliente dialogo = new DialogoFormularioCliente(PanelClientes.this);
	...
	public void mostrarClientes(List<Cliente> listaClientes) {
		tableReservas.setModel(new ModeloTablaClientes(listaClientes));		
	...
	public void mostrarClientesBaja(List<Cliente> listaClientesBaja) {
		tableReservas.setModel(new ModeloTablaClientes(listaClientesBaja));			
